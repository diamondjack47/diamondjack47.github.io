...
### Role: Hardware Design Engineer | Tech Stack: Verilog HDL, Intel ModelSim, Digital Logic Design
...
### Role: Embedded Systems Engineer | Tech Stack: C/C++, ESP32/Arduino, SPI/I2C Protocols, Bluetooth
Developed a contactless, real-time attendance tracking system utilizing a microcontroller paired with an MFRC522 RFID reader and an I2C Liquid Crystal Display. The custom firmware operates over the SPI bus to authenticate, read, and parse 32-byte user name strings from MIFARE tags. Integrated the BluetoothSerial library to enable the secure, trigger-based wireless exportation of attendance logs directly to a mobile device.

## Analog Battery Level Indicator
### Role: Analog Circuit Designer | Tech Stack: Analog Circuit Design, Multisim, PCB Prototyping
